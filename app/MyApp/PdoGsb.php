 ...
 */
    ...
    public function modifVisiteur($id,$nom,$prenom,$login,$mdp,$adresse,$cp,$ville,$dateEmbauche){
    ...
    public function supprimerLigneFraisForfais($id){
        $req = "DELETE FROM `lignefraisforfait` WHERE idVisiteur = '$id'";
        $res = $this->monPdo->query($req);
    }
    public function supprimerFicheFrais($id){
        $req = "DELETE FROM `fichefrais` WHERE idVisiteur = '$id'";
        $res = $this->monPdo->query($req);
    }

    public function ajtVisiteur($id,$nom,$prenom,$login,$mdp,$adresse,$cp,$ville,$dateEmbauche){
